...
btn1=Button(root, text="Btn 1")
btn2=Button(root, text="Btn 2")
btn3=Button(root, text="Btn 3")
btn4=Button(root, text="Btn 4")
btn5=Button(root, text="Btn 5")
btn6=Button(root, text="Btn 6")

# Use grid to alignment.
